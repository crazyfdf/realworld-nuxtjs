...
/* harmony import */ var _request_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9);
...
function getApiObj(url) {
  ...
  let api = _request_api__WEBPACK_IMPORTED_MODULE_0__[/* default */ "b"];
  apiArray.forEach(v => {
    api = api[v];
  });
  return api;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: { // 将vuex的state中的所有变量，解构到全局混入的mixin中
    ...Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])($storeKey)
  }
});
...
/* harmony import */ var _plugins_request_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony default export */ __webpack_exports__["b"] = ({
  /* 用户 */
  users: {
    /** 用户登录 ↓ **/
...
const addFavorite = slug => {
  return Object(_plugins_request_js__WEBPACK_IMPORTED_MODULE_0__[/* request */ "c"])({
    method: "POST",
...
const cookieparser =  true ? __webpack_require__(26) : undefined; // 需要永久存储，在state中的变量名

let saveStateKeys = ["user"]; // 获取本地存储中的变量
...
const mutations = {
  _commitAll(state, payload) {
    console.log(payload); // 判断是否多层级调用，state中为对象存在的情况，诸如user.info.score = 1
...
const _86b262c0 = () => interopDefault(__webpack_require__.e(/* import() */ 4).then(__webpack_require__.bind(null, 30)));

const _03a72dd5 = () => interopDefault(__webpack_require__.e(/* import() */ 3).then(__webpack_require__.bind(null, 31)));

const _7176d533 = () => interopDefault(__webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(null, 32)));

const _6f85b61a = () => interopDefault(__webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(null, 33)));

const _5eb0ebce = () => interopDefault(__webpack_require__.e(/* import() */ 7).then(__webpack_require__.bind(null, 34)));

const _9e50163a = () => interopDefault(__webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 35)));

const _a1f12f80 = () => interopDefault(__webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, 29)));
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(6), 'store.mixin.js'); // If the environment supports hot reloading...
})(); // createStore
...
// EXTERNAL MODULE: ./store/store.mixin.js
var store_mixin = __webpack_require__(6);

// EXTERNAL MODULE: external "dayjs"
var external_dayjs_ = __webpack_require__(17);
var external_dayjs_default = /*#__PURE__*/__webpack_require__.n(external_dayjs_);

// CONCATENATED MODULE: ./plugins/uct/index.js
...
/* harmony default export */ var uct = ({
  install
});
// CONCATENATED MODULE: ./plugins/main.js


external_vue_default.a.use(uct);
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof request["b" /* default */] === 'function') {
    await Object(request["b" /* default */])(app.context, inject);
